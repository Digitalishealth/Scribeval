...
includes a 20-case synthetic review manifest, a blinded reviewer worksheet, an
8-case bootstrap corpus of complete synthetic transcript/note packets, and example
