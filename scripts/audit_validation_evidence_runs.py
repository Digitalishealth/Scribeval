...
def audit_review_materials(
    ...
    require(
        review_materials.get("independent_review_runbook_sha256")
        == source_hashes.get("independent_review_runbook_sha256"),
    ...
    require(
        review_materials.get("reviewer_recruitment_plan_sha256")
        == source_hashes.get("reviewer_recruitment_plan_sha256"),
        f"{bundle_name} reviewer recruitment plan hash drift",
    )
    require(
    ...
    require(
        review_materials.get("reviewer_intake_checklist_sha256")
        == source_hashes.get("reviewer_intake_checklist_sha256"),
    ...
    require(
        isinstance(review_materials.get("reviewer_recruitment_plan"), str)
        and review_materials.get("reviewer_recruitment_plan"),
        f"{bundle_name} review materials missing reviewer recruitment plan path",
    )
    require(
