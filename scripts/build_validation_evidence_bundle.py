...
def build_review_materials_provenance(
    *,
    ...
    if not independent_review_runbook.exists():
        raise ValueError(
    ...
    return {
        ...
        "independent_review_runbook": relative_to_base(
            independent_review_runbook,
            bundle_dir,
        ),
...
def bundle_manifest(
    *,
    ...
    source_hashes = {
        ...
        "reviewer_intake_checklist_sha256": review_materials[
